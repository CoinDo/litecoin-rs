use crate::v1::helpers::errors::{execution, invalid_params, unimplemented};
use crate::v1::traits::raw::Raw;
...
use serialization::{deserialize, serialize, Reader};
use sync;
    ...
    T: RawClientCoreApi,
{
    ...
    fn decode_raw_transaction(&self, _transaction: RawTransaction) -> Result<Transaction, Error> {
        Err(unimplemented(None))
    }

    fn get_raw_transaction(
        &self,
        _hash: H256,
        _verbose: Trailing<bool>,
